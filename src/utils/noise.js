...
import { rngRangeFloor } from './random.js'
...
const createNoiseGenerator = () => {
  const permutations = Array.from({ length: 512 }, () => rngRangeFloor(0, gradients.length - 1))
  const hash = input => permutations[input % permutations.length]
...
export default createNoiseGenerator
